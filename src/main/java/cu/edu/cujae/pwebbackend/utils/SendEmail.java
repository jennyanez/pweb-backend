package cu.edu.cujae.pwebbackend.utils;
...
public class SendEmail {
    ...
    public void sendEmail(String email, String name, String subject, String randomPIN)
        ...
        msg.setFrom(new InternetAddress("pweb.library@gmail.com", false));
        ...
        String htmlMsg =
                "<h3>Hola, " +
                        ...
                        randomPIN +
                        "</p><br><p>Saludos,<br>Libreria Cujae</p>";
