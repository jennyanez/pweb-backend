...
public class UserPrincipal implements UserDetails {
    ...
    public UserPrincipal(int code, String username, String password, String email, String recoverCode,
    ...
    public static UserPrincipal create(UserDto user) {
        ...
        return new UserPrincipal(user.getCode(), user.getUsername(), user.getPassword(), user.getEmail(),user.getRecoverCode(),
                true, authorities);
    }
